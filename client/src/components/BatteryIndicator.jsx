...
const BatteryIndicator = ({ percentage, className = "" }) => {
    ...
    return (
        <div className={`flex items-center ${className}`}>
            <div className="relative w-6 h-3 border border-gray-400 rounded-md p-[1.5px] flex items-center bg-gray-50/50">
                <div
                    className={`h-full rounded-[3px] bg-gradient-to-r transition-all duration-500 ${gradientClass}`}
